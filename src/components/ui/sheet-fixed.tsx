...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      onOpenAutoFocus={(e) => {
        // Prevent autofocus which can break input fields
        e.preventDefault();
      }}
      onInteractOutside={(e) => {
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 z-[102] rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
        <X className="h-4 w-4" />
